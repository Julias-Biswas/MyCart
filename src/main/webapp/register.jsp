					...
					<div class="card">
						<div class="card-header bg-primary text-white">
							<h2 class="text-center">
								<img alt="Sign Up" src="img/signup.png" height="70">
							</h2>
							<h2 class="text-center my-1">Sign Up Here !!</h2>
						</div>
							...
							<form class="needs-validation" novalidate
								...
								<div class="form-row">
									<div class="col-md-12 mb-3">
										<label for="userName">Name</label><span class="text-danger">
								...
								<div class="form-row">
									<div class="col-md-12 mb-3">
										<label for="userPhone">Phone</label><span class="text-danger">
											*</span> <input type="number" class="form-control" id="userPhone"
											placeholder="Your Phone" name="userPhone" required>
										<div class="valid-feedback">Looks good!</div>
								...
								<div class="form-row">
									<div class="col-md-12 mb-3">
										<label for="userAddress">Address</label><span
											class="text-danger"></span>
										<textarea class="form-control" id="userAddress"
											placeholder="Your Address" name="userAddress" rows="num"
											cols="num" style="resize: none"></textarea>
										<div class="valid-feedback">Looks good!</div>
								...
								<div class="container text-center my-4">
									<button class="btn btn-success border-0" type="submit">Register</button>
									<button class="btn btn-danger border-0" type="reset">Reset</button>
								</div>
								<p class="text-center">
									Already have an account ? <span class="text-uppercase"><a
										href="login" class="footer-hoperlink">Click Here</a></span>
								</p>
							</form>
						</div>
